...
import {
  ...
  hasClass,
  removeClass
} from "./chunk-7VR6KRC4.js";
import {
  require_react_dom
} from "./chunk-ZUD27R6Z.js";
import {
  require_jsx_runtime
} from "./chunk-QI5RKK47.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  init_extends,
  init_objectWithoutPropertiesLoose
} from "./chunk-GD6VNWLD.js";
import {
  require_prop_types
} from "./chunk-3PKO7REV.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-ZGLKAHI3.js";
...
var divWithClassName_default = (className) => React14.forwardRef((p, ref) => (0, import_jsx_runtime10.jsx)("div", {
  ...p,
  ref,
...
var Button = React16.forwardRef((_ref, ref) => {
  let {
    as: asProp,
    disabled
...
var Anchor = React17.forwardRef((_ref, ref) => {
  let {
    onKeyDown
...
var AlertLink = React18.forwardRef(({
  className,
  bsPrefix,
...
var Alert = React21.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
  ...
  return (0, import_jsx_runtime17.jsx)(Transition, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
var ButtonToolbar = React27.forwardRef(({
  bsPrefix,
  className,
  role = "toolbar",
  ...props
...
var CardBody = React28.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardFooter = React29.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardHeader = React31.forwardRef(({
  bsPrefix,
  className,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
var CardImg = React32.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var CardImgOverlay = React33.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React34.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React35.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React36.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var CardGroup = React39.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useMounted2() {
  const mounted = (0, import_react30.useRef)(true);
  const isMounted = (0, import_react30.useRef)(() => mounted.current);
...
function useUpdatedRef(value) {
  const valueRef = (0, import_react31.useRef)(value);
...
function useWillUnmount(fn) {
  ...
  (0, import_react32.useEffect)(() => () => onUnmount.current(), []);
}
...
function useTimeout() {
  ...
  const handleRef = (0, import_react33.useRef)();
...
var CarouselCaption = React40.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function map(children, func) {
  let index = 0;
  return React42.Children.map(children, (child) => React42.isValidElement(child) ? func(child, index++) : child);
}
...
function hasChildOfType(children, type) {
  return React42.Children.toArray(children).some((child) => React42.isValidElement(child) && child.type === type);
}
...
var Carousel = React43.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react34.useRef)(null);
  const [direction, setDirection] = (0, import_react34.useState)("next");
  const [paused, setPaused] = (0, import_react34.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react34.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react34.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react34.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react34.useRef)();
  ...
  const handleEnter = (0, import_react34.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null || onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react34.useCallback)(() => {
    setIsSliding(false);
    onSlid == null || onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react34.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null || onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react34.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null || onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react34.useRef)(0);
  const touchDeltaXRef = (0, import_react34.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react34.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react34.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react34.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react34.useRef)();
  (0, import_react34.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react34.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
    ...
    children: [indicators && (0, import_jsx_runtime38.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime38.jsx)(TransitionWrapper_default, {
          ...
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React43.cloneElement(child, {
            ...innerProps,
...
var Container = React45.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react35.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react35.useState)(defaultValue);
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react35.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react36.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}

// node_modules/@restart/ui/esm/DropdownContext.js
var React46 = __toESM(require_react());
var DropdownContext = React46.createContext(null);
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react37.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react38.useRef)(modifiers);
  const popperInstanceRef = (0, import_react38.useRef)();
  const update = (0, import_react38.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react38.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react38.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react38.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react38.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react39.useRef)(false);
  const waitingForTrigger = (0, import_react39.useRef)(false);
  const handleMouseCapture = (0, import_react39.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react40.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react40.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react41.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react41.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react41.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react41.useState)(true);
  let value = (0, import_react41.useMemo)(() => ({
  ...
  return (0, import_react41.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react41.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react41.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react41.default).createElement((0, import_react41.default).Fragment, null, props.children);
  }
  return (0, import_react41.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react41.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react41.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react41.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react41.default).useId();
  let [didSSR] = (0, import_react41.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react41.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react41.default)["useSyncExternalStore"] === "function")
    return (0, import_react41.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react41.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react42.useContext)(DropdownContext_default) || {};
...
var SelectableContext = React49.createContext(null);
...
var NavContext = React50.createContext(null);
...
var DropdownItem = React51.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
...
var Context = (0, import_react44.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react44.useContext)(Context);
}
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react45.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react45.useRef)(null);
  const focusInDropdown = (0, import_react45.useRef)(false);
  const onSelectCtx = (0, import_react45.useContext)(SelectableContext_default);
  const toggle = (0, import_react45.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context6 = (0, import_react45.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react45.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var DropdownContext2 = React53.createContext({});
...
var DropdownDivider = React54.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "hr",
  role = "separator",
...
var DropdownHeader = React55.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  role = "heading",
...
var DropdownItem2 = React56.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var DropdownItemText = React57.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react46.useLayoutEffect : import_react46.useEffect;
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react47.useCallback)((refValue) => {
...
var DropdownMenu2 = React60.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react48.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react48.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React61.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  const dropdownContext = (0, import_react49.useContext)(DropdownContext_default);
...
var Dropdown2 = React62.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
...
var DropdownButton = React63.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
...
var FigureCaption = React66.forwardRef(({
  className,
  bsPrefix,
...
var Feedback = React68.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormCheckInput = React70.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React71.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React72.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
var FormControl = React73.forwardRef(({
  bsPrefix,
  type,
  size: size2,
  htmlSize,
...
var FormFloating = React74.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React75.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
}, ref) => {
  const context6 = (0, import_react55.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React76.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "label",
  bsPrefix,
  column = false,
...
var FormRange = React77.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React78.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React79.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React80.forwardRef((props, ref) => (0, import_jsx_runtime73.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React81.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var InputGroupText = React83.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroup = React84.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
...
function useMergedRefs2(refA, refB) {
  return (0, import_react60.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
var useMergedRefs_default2 = useMergedRefs2;

// node_modules/@restart/ui/esm/TabContext.js
var React85 = __toESM(require_react());
var TabContext = React85.createContext(null);
...
function useNavItem({
  ...
  const parentOnSelect = (0, import_react61.useContext)(SelectableContext_default);
  const navContext = (0, import_react61.useContext)(NavContext_default);
  const tabContext = (0, import_react61.useContext)(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
var NavItem = React86.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React87.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react62.useRef)(false);
  const parentOnSelect = (0, import_react62.useContext)(SelectableContext_default);
  const tabContext = (0, import_react62.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react62.useRef)(null);
...
var ListGroupItem = React88.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React89.forwardRef((props, ref) => {
  const {
    className,
...
function useCallbackRef2() {
  return (0, import_react63.useState)(null);
}
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react66.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react67.useRef)(inProp);
  ...
  const child = (0, import_react67.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react68.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react68.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react68.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react68.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react68.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react68.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react68.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react68.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React90.forwardRef((_ref, ref) => {
  let {
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react69.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react69.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react70.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react70.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react70.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react70.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react70.useState)(!show);
  const lastFocusRef = (0, import_react70.useRef)(null);
  (0, import_react70.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react70.useRef)();
  const removeKeydownListenerRef = (0, import_react70.useRef)();
  ...
  return (0, import_jsx_runtime85.jsx)(import_jsx_runtime85.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime85.jsxs)(import_jsx_runtime85.Fragment, {
...
var ModalBody = React93.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalFooter = React96.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React97.forwardRef(({
  ...
  const context6 = (0, import_react71.useContext)(ModalContext_default);
...
var ModalTitle = React99.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React100.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react72.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react72.useState)(false);
  const waitingForMouseUpRef = (0, import_react72.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react72.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react72.useRef)(null);
  ...
  const renderBackdrop = (0, import_react72.useCallback)((backdropProps) => (0, import_jsx_runtime93.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React101.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav2 = React103.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react73.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react73.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarBrand = React104.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React105.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context6 = (0, import_react74.useContext)(NavbarContext_default);
...
var NavbarToggle = React106.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react75.useContext)(NavbarContext_default) || {};
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react76.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react77.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React107.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime101.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: getChildRef(children),
    children: (status, innerProps) => React108.cloneElement(children, {
      ...innerProps,
...
var OffcanvasTitle = React110.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React111.forwardRef(({
  ...
  const modalManager = (0, import_react78.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react78.useState)(false);
  const handleHide = useEventCallback(onHide);
  const hideResponsiveOffcanvas = useBreakpoint_default(responsive || "xs", "up");
  (0, import_react78.useEffect)(() => {
    setShowOffcanvas(responsive ? show && !hideResponsiveOffcanvas : show);
  }, [show, responsive, hideResponsiveOffcanvas]);
  const modalContext = (0, import_react78.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  function getModalManager() {
    if (propsManager)
  ...
  const renderBackdrop = (0, import_react78.useCallback)((backdropProps) => (0, import_jsx_runtime104.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React112.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context6 = (0, import_react79.useContext)(NavbarContext_default);
...
var NavbarText = React113.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React114.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react80.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react80.useMemo)(() => ({
...
var Overlay = React116.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react82.useState)(!props.show);
...
var PopoverHeader = React117.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React118.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Overlay2 = React122.forwardRef(({
  ...
  const popperRef = (0, import_react84.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react84.useState)(null);
...
var triggerType = import_prop_types7.default.oneOf(["click", "hover", "focus"]);
var OverlayTrigger = ({
  trigger = ["hover", "focus"],
  overlay,
  children,
  ...
  const triggerNodeRef = (0, import_react85.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, getChildRef(children));
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react85.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React123.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react85.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react85.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react85.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react85.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react85.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react85.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react85.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime121.jsxs)(import_jsx_runtime120.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react85.cloneElement)(children, triggerProps), (0, import_jsx_runtime119.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React124.forwardRef(({
    children,
    ...props
...
var Pagination = React125.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var Placeholder = React127.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React128.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime127.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react86.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var propTypes6 = {
   ...
   */
  toggleLabel: import_prop_types8.default.string,
   ...
   *
   */
  flip: import_prop_types8.default.bool,
  /** @ignore */
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react87.useContext)(TabContext_default);
  if (!context6)
    return [Object.assign({}, props, {
      role
    }), {
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime134.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime134.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime134.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react88.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react88.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContent = React137.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React138.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime138.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime138.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime138.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
// node_modules/react-bootstrap/esm/Tab.js
var propTypes7 = {
  eventKey: import_prop_types10.default.oneOfType([import_prop_types10.default.string, import_prop_types10.default.number]),
  /**
   ...
   */
  tabClassName: import_prop_types10.default.string,
  /**
   * Object containing attributes to pass to underlying nav link.
   */
  tabAttrs: import_prop_types10.default.object
};
var Tab = () => {
...
var ToastFade = React141.forwardRef((props, ref) => (0, import_jsx_runtime142.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React143.forwardRef(({
  ...
  const context6 = (0, import_react89.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastBody = React144.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React145.forwardRef(({
  ...
  const delayRef = (0, import_react90.useRef)(delay);
  const onCloseRef = (0, import_react90.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react90.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react90.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  return (0, import_jsx_runtime146.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime146.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
